...
ImageLabel.Image = "https://create.roblox.com/store/asset/91548547963556/Nazu-hub?assetType=Decal&externalSource=www"
...
Tabs.BF:AddParagraph({
        Title = "Blox Fruits",
        Content = "All script support for Blox fruits"
    })
wait(5)
Tabs.BF:AddButton({
        Title = "Redz Hub",
...
Tabs.SP:AddButton({
        Title = "Yukstore.com",
        Description = "Shốp bán key script và client",
        Callback = function()
...
Tabs.If:AddParagraph({
    ...
    Tabs.If:AddParagraph({
        Title = "lấy cảm ứng từ",
        Content = "được share bởi LongHip12"
    })
